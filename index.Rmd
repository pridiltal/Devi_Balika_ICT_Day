...
---
class: top, left
background-image:url('fig/disney.png')
background-position: 50% 80%
background-size: cover
...
---
class: inverse, center, middle
background-image:url('fig/uom1.jpg')
background-position: 50% 80%
background-size: cover

# <span style="color: white; background-color: black;">Calling all Tech Enthusiasts!</span>

# </br></br><span style="color: white; background-color: black;">University of Moratuwa</span>

# <span style="color: white; background-color: black;">Awaits You!</span>

</br></br><span style="color: white; background-color: black;">`r icon::fa("github")` 
`r icon::fa("twitter")`pridiltal 

<span style="color: white; background-color: black;">
`r icon::fa("globe")` prital.netlify.app</span>

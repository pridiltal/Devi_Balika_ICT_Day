...
#### <span style="color:#040a47">Associate Investigator of the Australian Research Council </br>  Centre  of Excellence for Mathematical and Statistical  </br> Frontiers (ACEMS), Australia</span>
...
# <span style="color:#000000">Devi Balika Vidyalaya </br> Grade 6 -13</span>
...
## Artificial intelligence systems that are designed and trained for<span style="color:blue"> tasks or domains</span>.
---

class: top, left
background-image:url('fig/siri.jpg')
background-position: 50% 80%
background-size: 100%
---
class: top, left
...
---
class: top, left
background-image:url('fig/spacecases.jpg')
background-position: 50% 50%
background-size: 90%
---
class: top, left
...
---
class: top, left
background-image:url('fig/Spellbinder.png')
background-position: 50% 80%
background-size: 100%
---
...
## <span style="color: black; background-color: white;">Risk to Humanity: ASI could endanger humanity if its goals don't match human values.</span>
---
class: bottom, center
...
## <span style="color: black; background-color: white;">Job Loss: ASI could replace humans in jobs, causing economic problems.</span>
---
class: bottom, center
...
## <span style="color: black; background-color: white;">Loss of Control: Once ASI is smarter than us, we might not be able to control it.</span>
...
## <span style="color: black; background-color: white;">Weaponization: ASI could be used for harm by bad people or countries.</span>
...
## <span style="color: black; background-color: white;">Unpredictable Behavior: ASI may do things we can't predict because it's much smarter than humans.</span>
